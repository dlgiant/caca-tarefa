...
export function ChatWidget({ onTaskCreate, onProductivityAnalysis, className }: ChatWidgetProps) {
          ...
          >
            ...
            <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-purple-600 to-blue-600 text-white">
              <div className="flex flex-col">
                ...
                <span className="text-xs opacity-80 ml-7">Powered by Claude</span>
              </div>
              <button
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      ...
                      {message.role === 'assistant' && message.metadata?.model && (
                        <span className="text-xs opacity-60">• {message.metadata.model}</span>
                      )}
                    </div>
                  </div>
