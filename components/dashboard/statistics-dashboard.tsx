    ...
    <div className="space-y-6">
        ...
        <Card>
          ...
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
              <LineChart data={timeRange === 'week' ? stats.weeklyProgress : stats.monthlyProgress}>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {stats.completionRate > 70 ? 'Excelente!' : stats.completionRate > 50 ? 'Bom progresso' : 'Precisa melhorar'}
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{stats.averageCompletionTime} dias</div>
            <p className="text-xs text-muted-foreground">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{stats.productivityScore}/100</div>
            <div className="mt-2">
